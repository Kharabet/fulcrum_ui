...
export class CollateralTokenButton extends Component<
  ICollateralTokenButtonProps,
  ICollateralTokenButtonState
> {
    ...
    return (
      <React.Fragment>
        {this.state.assetDetails ? (
          <div
            className={`collateral-token-button ${
              this.props.isChangeCollateralOpen ? 'opened' : 'closed'
            }`}
