...
export class OwnTokenGridRow extends Component<IOwnTokenGridRowProps, IOwnTokenGridRowState> {
  ...
  public componentDidUpdate(prevProps: Readonly<IOwnTokenGridRowProps>, prevState: Readonly<IOwnTokenGridRowState>, snapshot?: any): void {
  ...
  public render() {
    ...
    <span className="own-token-grid-row__body-header">Position({this.props.baseToken}/{this.props.quoteToken})</span>
        ...
        <div className="own-token-grid-row__col-collateral opacityIn">
          ...
          <div className={`own-token-grid-row__open-manage-collateral ${this.props.loan.collateralizedPercent.lte(.25) ? "danger" : ""}`} onClick={this.onManageClick}>
        ...
        <div className="own-token-grid-row__col-action opacityIn rightIn">
          <button className="own-token-grid-row_button own-token-grid-row__sell-button own-token-grid-row__button--size-half" onClick={this.onSellClick} disabled={this.props.loan.collateralizedPercent.lte(.25)}>
            {TradeType.SELL}
          </button>
        </div>
      </div>
