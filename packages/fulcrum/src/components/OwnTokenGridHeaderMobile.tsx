...
export class OwnTokenGridHeaderMobile extends Component<IOwnTokenGridHeaderProps> {
  public render() {
    return (
      <div className="own-token-grid-header">
        ...
        {/*</div>*/}
        <div className="own-token-grid-header__col-asset-price">
          <span className="own-token-grid-header__text">Price</span>
        </div>
        <div className="own-token-grid-header__col-liquidation-price">
          <span className="own-token-grid-header__text">Liquidation</span>
        </div>
