    ...
    return (
      <React.Fragment>
        ...
        <div className="collateral-token-selector">
          <div className="collateral-token-selector__title">
            Select {this.props.collateralType} token
          </div>
          ...
          <p className="collateral-token-selector__description">
            {!this.props.tradeType
              ...
              : `There are a few options for redemption tokens available and you can choose any token to swap during closing trade(and thus save time on visiting exchange).`}
          </p>
        </div>
      </React.Fragment>
    )
