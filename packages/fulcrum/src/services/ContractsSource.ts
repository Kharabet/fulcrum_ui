  ...
  public getiBZxAddress(): string {
    ...
    switch (this.networkId) {
      ...
      case 4:
        ...
        break;
      case 42:
        address = "0x65Bb7cb3e15684270F1CF64c85c5A8B835f4C201";
        break;
    }
  ...
  public getOracleAddress(): string {
    ...
    switch (this.networkId) {
      ...
      case 4:
        ...
        break;
      case 42:
        address = "0x902A75763F1C7aAFA02d5e7Ea9A43280288b54f0";
        break;
    }
  ...
  private getDAppHelperAddress(): string {
    ...
    switch (this.networkId) {
      ...
      case 4:
        ...
        break;
      case 42:
        address = "0x3B6E375b5afd0CDC1c7f9Bc1ebEE88099D21325C";
        break;
    }
