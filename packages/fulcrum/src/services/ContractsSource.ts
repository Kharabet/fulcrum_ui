...
export class ContractsSource {
  ...
  private static iTokensContractInfos: Map<string, ITokenContractInfo> = new Map<
    ...
    ITokenContractInfo
  >()
  private static pTokensContractInfos: Map<string, ITokenContractInfo> = new Map<
    string,
    ITokenContractInfo
  >()
  private static pTokensContractInfosBurnOnly: Map<string, ITokenContractInfo> = new Map<
    string,
    ITokenContractInfo
  >()
  ...
  public getOracleAddress(): string {
    ...
    switch (this.networkId) {
      case 1:
        address = '0xC2f15CEE4Ff3A9de8Aa3759051722ffC245C186C'
        break
      case 3:
  ...
  private async getPTokenContractRaw(key: TradeTokenKey): Promise<pTokenContract | null> {
    ...
    return tokenContractInfo
      ? new pTokenContract(ContractsSource.pTokenJson.abi, tokenContractInfo.token, this.provider)
      : null
  }
