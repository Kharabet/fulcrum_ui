...
function createAlchemyWeb3(alchemyUrl, config) {
  ...
  alchemyWeb3.setWriteProvider = function(provider) {
...
function fillInConfigDefaults(_a) {
  var _b = _a.writeProvider,
    writeProvider = _b === void 0 ? getWindowProvider() : _b,
    _c = _a.maxRetries,
    maxRetries = _c === void 0 ? DEFAULT_MAX_RETRIES : _c,
    _d = _a.retryInterval,
    retryInterval = _d === void 0 ? DEFAULT_RETRY_INTERVAL : _d,
    _e = _a.retryJitter,
    retryJitter = _e === void 0 ? DEFAULT_RETRY_JITTER : _e;
  return {
    ...
    return __generator(this, function(_b) {
      switch (_b.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            sendToAlchemyWithRetries(payload, alchemyUrl, config),
          ];
        case 2:
        ...
        case 9:
          if (!writeProvider) {
            throw new Error(
              'No provider available for method "' + payload.method + '"',
            );
          }
...
function sendToProvider(payload, provider) {
  ...
  if (anyProvider.sendAsync) {
    return promisify(function(callback) {
      return anyProvider.sendAsync(payload, callback);
    });
  } else {
    return promisify(function(callback) {
      return anyProvider.send(payload, callback);
    });
  }
}
...
function processTokenBalanceResponse(rawResponse) {
  ...
  var fixedTokenBalances = rawResponse.tokenBalances.map(function(balance) {
    return balance.tokenBalance != null
      ? __assign({}, balance, {
          tokenBalance: hexToDecimal(balance.tokenBalance),
        })
      : balance;
  });
