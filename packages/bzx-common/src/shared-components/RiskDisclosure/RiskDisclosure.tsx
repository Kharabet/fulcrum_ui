...
const RiskDisclosure = (props: IRiskDisclosureProps) => {
  const onTokenAddressFormRequestClose = () => {
    props.onClose()
  }
  return (
    <div className="disclosure">
      <div className="disclosure__header">
        <h2 className="disclosure__title">DeFi Risk Disclosure</h2>
        <div className="disclosure__close" onClick={props.onClose}>
          <CloseIcon />
        </div>
      </div>
      <div className="disclosure__content">
        ...
        <p>
          Unlike mainstream financial services, our team can NOT help you recover your funds if you
        ...
        <p>
          ...
          how to secure their digital assets against the basic risks associated with dApps, however,
          it’s important to consider that using emerging technologies constitutes a risk unto
          itself.
        </p>
        <p>
      ...
      <div className="disclosure__actions">
        <button onClick={onTokenAddressFormRequestClose}>Got it!</button>
      </div>
    </div>
  )
}
