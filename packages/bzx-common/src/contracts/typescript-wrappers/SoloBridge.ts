  ...
  public migrateLoan = {
    async sendTransactionAsync(
      ...
      const encodedData = self._strictEncodeArguments(
        'migrateLoan((address,uint256),uint256,uint256,uint256[],uint256[],uint256[],uint256[])',
        [account, marketId, loanAmount, marketIds, amounts, collateralAmounts, borrowAmounts]
      )
