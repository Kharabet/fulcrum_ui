...
export type saiToDAIBridgeEventArgs = saiToDAIBridgeOwnershipTransferredEventArgs
...
export class saiToDAIBridgeContract extends BaseContract {
  ...
  public _migrateLoan = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as saiToDAIBridgeContract
      const encodedData = self._strictEncodeArguments('_migrateLoan(bytes32,address,uint256)', [
        loanId,
        borrower,
        migrationAmount
      ])
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self._web3Wrapper.getContractDefaults(),
        (self as any)._migrateLoan.estimateGasAsync.bind(self, loanId, borrower, migrationAmount)
      )
    ...
    getABIEncodedTransactionData(
      ...
      const abiEncodedTransactionData = self._strictEncodeArguments(
        ...
        [loanId, borrower, migrationAmount]
      )
  ...
  public migrateLoan = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as saiToDAIBridgeContract
      const encodedData = self._strictEncodeArguments('migrateLoan(bytes32,uint256)', [
        loanId,
        migrationAmount
      ])
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self._web3Wrapper.getContractDefaults(),
        (self as any).migrateLoan.estimateGasAsync.bind(self, loanId, migrationAmount)
      )
      const txHash = await self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)
      return txHash
    },
    ...
    getABIEncodedTransactionData(loanId: string, migrationAmount: BigNumber): string {
      const self = (this as any) as saiToDAIBridgeContract
      const abiEncodedTransactionData = self._strictEncodeArguments(
        'migrateLoan(bytes32,uint256)',
        [loanId, migrationAmount]
      )
      return abiEncodedTransactionData
    },
    async callAsync(
