...
export type convertEventArgs = convertConvertBZRXEventArgs | convertOwnershipTransferredEventArgs
...
export class convertContract extends BaseContract {
  ...
  public convert = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self._web3Wrapper.getContractDefaults(),
        (self as any).convert.estimateGasAsync.bind(self, _tokenAmount)
      )
      const txHash = await self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)
      return txHash
    },
    async estimateGasAsync(_tokenAmount: BigNumber, txData: Partial<TxData> = {}): Promise<number> {
      const self = (this as any) as convertContract
      const encodedData = self._strictEncodeArguments('convert(uint256)', [_tokenAmount])
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        {
    ...
    getABIEncodedTransactionData(_tokenAmount: BigNumber): string {
      const self = (this as any) as convertContract
      const abiEncodedTransactionData = self._strictEncodeArguments('convert(uint256)', [
        _tokenAmount
      ])
  ...
  public initialize = {
    async sendTransactionAsync(txData: Partial<TxData> = {}): Promise<string> {
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self._web3Wrapper.getContractDefaults(),
        (self as any).initialize.estimateGasAsync.bind(self)
      )
      const txHash = await self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)
      return txHash
    },
  ...
  public rescue = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as convertContract
      const encodedData = self._strictEncodeArguments('rescue(address,uint256)', [
        _receiver,
        _amount
      ])
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self._web3Wrapper.getContractDefaults(),
        (self as any).rescue.estimateGasAsync.bind(self, _receiver, _amount)
      )
      const txHash = await self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)
      return txHash
    },
    ...
    getABIEncodedTransactionData(_receiver: string, _amount: BigNumber): string {
      const self = (this as any) as convertContract
      const abiEncodedTransactionData = self._strictEncodeArguments('rescue(address,uint256)', [
        _receiver,
        _amount
      ])
      return abiEncodedTransactionData
