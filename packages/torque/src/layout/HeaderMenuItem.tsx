  ...
  public render() {
    return (
      <div className="header-menu__item">
        {this.props.external ? (
          <a href={this.props.link} className={`header-menu__item-link ${this.props.title === "Help Center" ? "c-primary-blue" : "c-green"}`}>
            {this.props.title !== "Help Center" ? (<span className="icon-external">
              <ExternalLink/>
            </span>) : null}
