...
export interface IRefinanceAssetCompoundLoanItemProps {
  loan: IRefinanceLoan
}
...
export class RefinanceAssetCompoundLoanItem extends Component<IRefinanceLoan, IRefinanceAssetCompoundLoanItemState> {
  ...
  public render() {
    ...
    let refRateYear = ((parseFloat(this.props.apr.dp(0, BigNumber.ROUND_CEIL).toString()) -  parseFloat(this.state.fixedApr.dp(1, BigNumber.ROUND_CEIL).toString())) * parseFloat(this.props.balance.dp(3, BigNumber.ROUND_FLOOR).toString()))/100;
    ...
    return (
      ...
      <div className={`refinance-asset-selector-item `} >
        ...
        <div className="refinance-asset-selector__row">
          <div className="refinance-asset-selector__marker"><img className="logo__dydx" src={compound_img} /> <img className="right-icon" src={arrow_right} /></div>
