    ...
    return (
      <div className={`provider-selector-item ${providerModifier}`} onClick={this.onClick}>
        <div className="provider-selector-item__content">
          ...
          {this.props.providerType === ProviderType.Squarelink 
          ? <span style={{fontSize: "10px", textAlign: "center", maxWidth: "80%", margin: "5px auto"}}>Please note: Squrelink has shutdown. We recommend to move to a different wallet.</span> 
          : null}
        </div>
      </div>
    );
