...
export class RefinanceCard extends Component<IRefinanceCardProps, IRefinanceCardState> {
    ...
    public showInfoCollateralAssetDt0 = () => {
        this._isMounted && this.setState({ ...this.state, isShowInfoCollateralAssetDt0: !this.state.isShowInfoCollateralAssetDt0 });
    };

    public showInfoCollateralAssetDt1 = () => {
        this._isMounted && this.setState({ ...this.state, isShowInfoCollateralAssetDt1: !this.state.isShowInfoCollateralAssetDt1 });
    };
    ...
    public render() {
        ...
        const refRateYear = ((parseFloat(this.props.variableAPR) - parseFloat(this.props.fixedAPR)) * parseFloat(this.props.balance)) / 100;
                ...
                <div className="refinance-asset__main-block">
                    ...
                    <div className="refinance-asset-selector__non-torque">
                        ...
                        <div className="refinance__input-container">
                            <input
                                className={`input-amount ${this.props.isWarning
                                    ? "warning"
                                    : ""}`}
                                type="number"
                                placeholder={`Amount`}
                            ...
                            />
                            {this.props.isWarning && <div className="refinance-details-msg--warning">
