export class AssetDetails {
  ...
  constructor(displayName: string, labelName: string, decimals: number, logoSvg: any, reactLogoSvg: any, bgSvg: any, tsSvg: any, bgColor: string, textColor: string, textColor2: string, addressErc20: Map<number, string | null>) {
