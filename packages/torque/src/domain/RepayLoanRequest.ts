...
export class RepayLoanRequest {
  ...
  constructor(borrowAsset: Asset, collateralAsset: Asset, accountAddress: string, loanId: string, repayAmount: BigNumber, repayPercent: BigNumber, amountOwed: BigNumber) {
