...
export class instaRegistryContract extends BaseContract {
  ...
  public enableStaticLogic = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self._web3Wrapper.getContractDefaults(),
        (self as any).enableStaticLogic.estimateGasAsync.bind(self, _logicAddress)
      )
      const txHash = await self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)
      return txHash
    },
    async estimateGasAsync(_logicAddress: string, txData: Partial<TxData> = {}): Promise<number> {
      const self = (this as any) as instaRegistryContract
      const encodedData = self._strictEncodeArguments('enableStaticLogic(address)', [_logicAddress])
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        {
    ...
    getABIEncodedTransactionData(_logicAddress: string): string {
      const self = (this as any) as instaRegistryContract
      const abiEncodedTransactionData = self._strictEncodeArguments('enableStaticLogic(address)', [
        _logicAddress
      ])
  ...
  public record = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as instaRegistryContract
      const encodedData = self._strictEncodeArguments('record(address,address)', [
        _currentOwner,
        _nextOwner
      ])
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self._web3Wrapper.getContractDefaults(),
        (self as any).record.estimateGasAsync.bind(self, _currentOwner, _nextOwner)
      )
      const txHash = await self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)
      return txHash
    },
    ...
    getABIEncodedTransactionData(_currentOwner: string, _nextOwner: string): string {
      const self = (this as any) as instaRegistryContract
      const abiEncodedTransactionData = self._strictEncodeArguments('record(address,address)', [
        _currentOwner,
        _nextOwner
      ])
      return abiEncodedTransactionData
  ...
  public enableLogic = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self._web3Wrapper.getContractDefaults(),
        (self as any).enableLogic.estimateGasAsync.bind(self, _logicAddress)
      )
      const txHash = await self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)
      return txHash
    },
    ...
    getABIEncodedTransactionData(_logicAddress: string): string {
      const self = (this as any) as instaRegistryContract
      const abiEncodedTransactionData = self._strictEncodeArguments('enableLogic(address)', [
        _logicAddress
      ])
      return abiEncodedTransactionData
    },
  ...
  public setAddress = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as instaRegistryContract
      const encodedData = self._strictEncodeArguments('setAddress(string,address)', [
        _name,
        _userAddress
      ])
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self._web3Wrapper.getContractDefaults(),
        (self as any).setAddress.estimateGasAsync.bind(self, _name, _userAddress)
      )
      const txHash = await self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)
      return txHash
    },
    ...
    getABIEncodedTransactionData(_name: string, _userAddress: string): string {
      const self = (this as any) as instaRegistryContract
      const abiEncodedTransactionData = self._strictEncodeArguments('setAddress(string,address)', [
        _name,
        _userAddress
      ])
      return abiEncodedTransactionData
  ...
  public disableLogic = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self._web3Wrapper.getContractDefaults(),
        (self as any).disableLogic.estimateGasAsync.bind(self, _logicAddress)
      )
      const txHash = await self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)
      return txHash
    },
    ...
    getABIEncodedTransactionData(_logicAddress: string): string {
      const self = (this as any) as instaRegistryContract
      const abiEncodedTransactionData = self._strictEncodeArguments('disableLogic(address)', [
        _logicAddress
      ])
      return abiEncodedTransactionData
    },
  ...
  public build2 = {
    async sendTransactionAsync(_owner: string, txData: Partial<TxData> = {}): Promise<string> {
      const self = (this as any) as instaRegistryContract
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self._web3Wrapper.getContractDefaults(),
        (self as any).build2.estimateGasAsync.bind(self, _owner)
      )
      const txHash = await self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)
      return txHash
    },
    async estimateGasAsync(_owner: string, txData: Partial<TxData> = {}): Promise<number> {
      const self = (this as any) as instaRegistryContract
      const encodedData = self._strictEncodeArguments('build(address)', [_owner])
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        {
