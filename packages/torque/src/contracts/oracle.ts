...
export class oracleContract extends BaseContract {
    public amountInEth = {
        ...
        > {
            ...
            const encodedData = self._strictEncodeArguments('amountInEth(address,uint256)', [tokenAddress,
        amount
        ]);
    ...
    public checkPriceDisagreement = {
        ...
        > {
            const self = this as any as oracleContract;
            const encodedData = self._strictEncodeArguments('checkPriceDisagreement(address,address,uint256,uint256,uint256)', [sourceToken,
        destToken,
        sourceAmount,
        destAmount,
        maxSlippage
            ...
            const rawCallResult = await self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock);
            BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
            const abiEncoder = self._lookupAbiEncoder('checkPriceDisagreement(address,address,uint256,uint256,uint256)');
            // tslint:disable boolean-naming
            const result = abiEncoder.strictDecodeReturnValue<BigNumber
        >(rawCallResult);
            // tslint:enable boolean-naming
    ...
    public getCurrentMargin = {
        ...
        > {
            const self = this as any as oracleContract;
            const encodedData = self._strictEncodeArguments('getCurrentMargin(address,address,uint256,uint256)', [loanToken,
        collateralToken,
        loanAmount,
        collateralAmount
        ]);
    ...
    public getCurrentMarginAndCollateralSize = {
        ...
        > {
            const self = this as any as oracleContract;
            const encodedData = self._strictEncodeArguments('getCurrentMarginAndCollateralSize(address,address,uint256,uint256)', [loanToken,
        collateralToken,
        loanAmount,
        collateralAmount
        ]);
            ...
            const rawCallResult = await self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock);
            BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
            const abiEncoder = self._lookupAbiEncoder('getCurrentMarginAndCollateralSize(address,address,uint256,uint256)');
            // tslint:disable boolean-naming
            const result = abiEncoder.strictDecodeReturnValue<[BigNumber, BigNumber]
        >(rawCallResult);
            // tslint:enable boolean-naming
    ...
    public getMaxDrawdown = {
        ...
        > {
            const self = this as any as oracleContract;
            const encodedData = self._strictEncodeArguments('getMaxDrawdown(address,address,uint256,uint256,uint256)', [loanToken,
        collateralToken,
        loanAmount,
        collateralAmount,
        margin
            ...
            const rawCallResult = await self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock);
            BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
            const abiEncoder = self._lookupAbiEncoder('getMaxDrawdown(address,address,uint256,uint256,uint256)');
            // tslint:disable boolean-naming
            const result = abiEncoder.strictDecodeReturnValue<BigNumber
        >(rawCallResult);
            // tslint:enable boolean-naming
    ...
    public queryPrecision = {
        ...
        > {
            const self = this as any as oracleContract;
            const encodedData = self._strictEncodeArguments('queryPrecision(address,address)', [sourceToken,
        destToken
        ]);
            const callDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
    ...
    public queryRate = {
        ...
        > {
            const self = this as any as oracleContract;
            const encodedData = self._strictEncodeArguments('queryRate(address,address)', [sourceToken,
        destToken
        ]);
            const callDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
    ...
    public queryReturn = {
        ...
        > {
            const self = this as any as oracleContract;
            const encodedData = self._strictEncodeArguments('queryReturn(address,address,uint256)', [sourceToken,
        destToken,
        sourceAmount
        ]);
            const callDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
    ...
    public setDecimals = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                ...
                self._web3Wrapper.getContractDefaults(),
                (self as any).setDecimals.estimateGasAsync.bind(
                    self,
                    tokens
                ),
            );
        ...
        getABIEncodedTransactionData(
            ...
            const self = this as any as oracleContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('setDecimals(address[])', [tokens
    ]);
    ...
    public setGlobalPricingPaused = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                ...
                self._web3Wrapper.getContractDefaults(),
                (self as any).setGlobalPricingPaused.estimateGasAsync.bind(
                    self,
                    isPaused
                ),
            );
        ...
        getABIEncodedTransactionData(
            ...
            const self = this as any as oracleContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('setGlobalPricingPaused(bool)', [isPaused
    ]);
            return abiEncodedTransactionData;
        },
        async callAsync(
    ...
    public setPriceFeed = {
        async sendTransactionAsync(
            ...
            const self = this as any as oracleContract;
            const encodedData = self._strictEncodeArguments('setPriceFeed(address[],address[])', [tokens,
    feeds
    ]);
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
                ...
                self._web3Wrapper.getContractDefaults(),
                (self as any).setPriceFeed.estimateGasAsync.bind(
                    self,
                    tokens,
                    feeds
                ),
    ...
    feeds
        ...
        getABIEncodedTransactionData(
            ...
            const self = this as any as oracleContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('setPriceFeed(address[],address[])', [tokens,
    feeds
    ]);
            return abiEncodedTransactionData;
        },
    ...
    public shouldLiquidate = {
        ...
        > {
            const self = this as any as oracleContract;
            const encodedData = self._strictEncodeArguments('shouldLiquidate(address,address,uint256,uint256,uint256)', [loanToken,
        collateralToken,
        loanAmount,
        collateralAmount,
        maintenanceMargin
            ...
            const rawCallResult = await self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock);
            BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
            const abiEncoder = self._lookupAbiEncoder('shouldLiquidate(address,address,uint256,uint256,uint256)');
            // tslint:disable boolean-naming
            const result = abiEncoder.strictDecodeReturnValue<boolean
        >(rawCallResult);
            // tslint:enable boolean-naming
