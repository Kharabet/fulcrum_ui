...
export class dsProxyJsonContract extends BaseContract {
  public setOwner = {
    async sendTransactionAsync(owner_: string, txData: Partial<TxData> = {}): Promise<string> {
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        (self as any).setOwner.estimateGasAsync.bind(self, owner_)
      )
      const txHash = await self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)
      return txHash
    },
    async estimateGasAsync(owner_: string, txData: Partial<TxData> = {}): Promise<number> {
      const self = (this as any) as dsProxyJsonContract
      const encodedData = self._strictEncodeArguments('setOwner(address)', [owner_])
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        {
    ...
    getABIEncodedTransactionData(owner_: string): string {
      const self = (this as any) as dsProxyJsonContract
  ...
  public execute = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as dsProxyJsonContract
      const functionSignature = txData.isInstaProxy
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self._web3Wrapper.getContractDefaults(),
        (self as any).execute.estimateGasAsync.bind(self, _target, _data, txData)
      )
      const txHash = await self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)
      return txHash
    },
    ...
    getABIEncodedTransactionData(_target: string, _data: string): string {
      const self = (this as any) as dsProxyJsonContract
      const abiEncodedTransactionData = self._strictEncodeArguments('execute(address,bytes)', [
        _target,
        _data
      ])
      return abiEncodedTransactionData
    ...
    async callAsync(
      ...
      const self = (this as any) as dsProxyJsonContract
      const encodedData = self._strictEncodeArguments('execute(address,bytes)', [_target, _data])
      const callDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        {
          to: self.address,
          ...callData,
  ...
  public setAuthority = {
    async sendTransactionAsync(authority_: string, txData: Partial<TxData> = {}): Promise<string> {
      const self = (this as any) as dsProxyJsonContract
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self._web3Wrapper.getContractDefaults(),
        (self as any).setAuthority.estimateGasAsync.bind(self, authority_)
      )
      const txHash = await self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)
      return txHash
    },
    async estimateGasAsync(authority_: string, txData: Partial<TxData> = {}): Promise<number> {
      const self = (this as any) as dsProxyJsonContract
      const encodedData = self._strictEncodeArguments('setAuthority(address)', [authority_])
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        {
    ...
    getABIEncodedTransactionData(authority_: string): string {
      const self = (this as any) as dsProxyJsonContract
      const abiEncodedTransactionData = self._strictEncodeArguments('setAuthority(address)', [
        authority_
      ])
      return abiEncodedTransactionData
    },
  ...
  public setCache = {
    async sendTransactionAsync(_cacheAddr: string, txData: Partial<TxData> = {}): Promise<string> {
      const self = (this as any) as dsProxyJsonContract
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self._web3Wrapper.getContractDefaults(),
        (self as any).setCache.estimateGasAsync.bind(self, _cacheAddr)
      )
      const txHash = await self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)
      return txHash
    },
    async estimateGasAsync(_cacheAddr: string, txData: Partial<TxData> = {}): Promise<number> {
      const self = (this as any) as dsProxyJsonContract
      const encodedData = self._strictEncodeArguments('setCache(address)', [_cacheAddr])
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        {
    ...
    getABIEncodedTransactionData(_cacheAddr: string): string {
      const self = (this as any) as dsProxyJsonContract
      const abiEncodedTransactionData = self._strictEncodeArguments('setCache(address)', [
        _cacheAddr
      ])
      return abiEncodedTransactionData
    },
