            ...
            ticks: {
              ...
              callback: (value: any, index: any, values: any) => {
                return this.props.isMobileMedia
                  ? index === 0 || index % 8 !== 0 || index === Object.keys(values).length - 1
                    ? ''
                    : value
        ...
        {this.props.isMainChart && (
          <div id="chartjs-tooltip">
            <table>
              <tbody>
                <tr>
                  <td className="chartjs-tooltip-time">1</td>
                </tr>
                <tr>
                  <td className="chartjs-tooltip-value">1</td>
                </tr>
                <tr>
                  <td className="chartjs-tooltip-change24">1</td>
                </tr>
              </tbody>
            </table>
          </div>
