...
export class OnChainIndicator extends Component<IOnChainIndicatorProps, IOnChainIndicatorState> {
    constructor(props: IOnChainIndicatorProps) {
        ...
        ExplorerProvider.Instance.eventEmitter.on(ExplorerProviderEvents.ProviderIsChanging, this.onProviderIsChanging);
    ...
    private async derivedUpdate() {
        ...
        if (accountText && ExplorerProvider.Instance.providerType !== ProviderType.None) {
            providerTypeDetails = ProviderTypeDictionary.providerTypes.get(ExplorerProvider.Instance.providerType);
        }
