...
export const GroupButton = (props: IGroupButtonProps) => {
  ...
  return (
    <div className="group-button">
      <button data-asset="365" onClick={onClick} className="button-period">
        1 Year
      </button>
      <button data-asset="90" onClick={onClick} className="button-period">
        90 Days
      </button>
      <button data-asset="30" onClick={onClick} className="button-period">
        30 Days
      </button>
      <button data-asset="1" onClick={onClick} className="button-period active">
        1 Day
      </button>
    </div>
  )
