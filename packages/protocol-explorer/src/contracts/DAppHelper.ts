  ...
  public setAddresses = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self._web3Wrapper.getContractDefaults(),
        (self as any).setAddresses.estimateGasAsync.bind(self, _bZxProtocol, _legacyVault)
      )
    ...
    getABIEncodedTransactionData(_bZxProtocol: string, _legacyVault: string): string {
      const self = (this as any) as DAppHelperContract
      const abiEncodedTransactionData = self._strictEncodeArguments(
        'setAddresses(address,address)',
        [_bZxProtocol, _legacyVault]
      )
