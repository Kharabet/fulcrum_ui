                ...
                <div className="row-container">
                  ...
                  <p className="warning">
                    {this.state.bzrxBalance.lt(this.state.bzrxStakingBalance) ?
                      "Your BZRX Wallet Balance less than Staking Balance"
                      : this.state.vBzrxBalance.lt(this.state.vBzrxStakingBalance) ?
                        "Your vBZRX Wallet Balance less than Staking Balance"
                        : this.state.bptBalance.lt(this.state.bptStakingBalance) ?
                          "Your BPT Wallet Balance less than Staking Balance" : ""}</p>
                </div>
