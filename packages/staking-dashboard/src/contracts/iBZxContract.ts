...
export class iBZxContract extends BaseContract {
    ...
    public closeWithSwapWithGasToken = {
        async sendTransactionAsync(
            ...
            const self = (this as any) as iBZxContract;
            const encodedData = self._strictEncodeArguments("closeWithSwapWithGasToken(bytes32,address,address,uint256,bool,bytes)", [
                loanId,
                receiver,
                gasTokenUser,
                swapAmount,
    ...
    public closeWithDepositWithGasToken = {
        async sendTransactionAsync(
            ...
            const self = (this as any) as iBZxContract;
            const encodedData = self._strictEncodeArguments("closeWithDepositWithGasToken(bytes32,address,address,uint256)", [
                loanId,
                receiver,
                gasTokenUser,
                depositAmount
    ...
    public rewardsBalanceOf = {
        async callAsync(
            ...
            const self = (this as any) as iBZxContract;
            const encodedData = self._strictEncodeArguments("rewardsBalanceOf(address)", [
                user
            ]);
            const callDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
    ...
    public claimRewards = {
        async sendTransactionAsync(
            ...
            const self = (this as any) as iBZxContract;
            const encodedData = self._strictEncodeArguments("claimRewards(address)", [
                receiver,
            ]);
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
                ...
                self._web3Wrapper.getContractDefaults(),
                (self as any).withdrawCollateral.estimateGasAsync.bind(self, receiver)
            );
            const txHash = await self._web3Wrapper.sendTransactionAsync(txDataWithDefaults);
            return txHash;
        },
