...
export class traderCompensationContract extends BaseContract {
    ...
    public optin = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                ...
                self._web3Wrapper.getContractDefaults(),
                (self as any).optin.estimateGasAsync.bind(
                    self,
                ),
            );
            const txHash = await self._web3Wrapper.sendTransactionAsync(txDataWithDefaults);
    ...
    public setOptin = {
        async sendTransactionAsync(
            ...
            const self = this as any as traderCompensationContract;
            const encodedData = self._strictEncodeArguments('setOptin(address,bool)', [addr,
    val
    ]);
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
                ...
                self._web3Wrapper.getContractDefaults(),
                (self as any).setOptin.estimateGasAsync.bind(
                    self,
                    addr,
                    val
                ),
    ...
    val
        ...
        getABIEncodedTransactionData(
            ...
            const self = this as any as traderCompensationContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('setOptin(address,bool)', [addr,
    val
    ]);
            return abiEncodedTransactionData;
        },
    ...
    public setTimestamps = {
        async sendTransactionAsync(
            ...
            const self = this as any as traderCompensationContract;
            const encodedData = self._strictEncodeArguments('setTimestamps(uint256,uint256,uint256)', [_optinStartTimestamp,
    _optinEndTimestamp,
    _claimEndTimestamp
    ]);
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
    ...
    _claimEndTimestamp
        ...
        getABIEncodedTransactionData(
            ...
            const self = this as any as traderCompensationContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('setTimestamps(uint256,uint256,uint256)', [_optinStartTimestamp,
    _optinEndTimestamp,
    _claimEndTimestamp
    ]);
            return abiEncodedTransactionData;
    ...
    public setWhitelist = {
        async sendTransactionAsync(
            ...
            const self = this as any as traderCompensationContract;
            const encodedData = self._strictEncodeArguments('setWhitelist(address[],uint256[])', [addrs,
    amounts
    ]);
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
                ...
                self._web3Wrapper.getContractDefaults(),
                (self as any).setWhitelist.estimateGasAsync.bind(
                    self,
                    addrs,
                    amounts
                ),
    ...
    amounts
        ...
        getABIEncodedTransactionData(
            ...
            const self = this as any as traderCompensationContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('setWhitelist(address[],uint256[])', [addrs,
    amounts
    ]);
            return abiEncodedTransactionData;
        },
    ...
    public withdrawVBZRX = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                ...
                self._web3Wrapper.getContractDefaults(),
                (self as any).withdrawVBZRX.estimateGasAsync.bind(
                    self,
                    _amount
                ),
            );
        ...
        getABIEncodedTransactionData(
            ...
            const self = this as any as traderCompensationContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('withdrawVBZRX(uint256)', [_amount
    ]);
            return abiEncodedTransactionData;
        },
        async callAsync(
