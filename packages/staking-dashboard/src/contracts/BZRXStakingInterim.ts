...
export class BZRXStakingInterimContract extends BaseContract {
    ...
    public balanceOfByAssetWalletAware = {
        ...
        > {
            const self = this as any as BZRXStakingInterimContract;
            const encodedData = self._strictEncodeArguments('balanceOfByAssetWalletAware(address,address)', [token,
        account
        ]);
            const callDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
    ...
    public getRepVotes = {
        ...
        > {
            const self = this as any as BZRXStakingInterimContract;
            const encodedData = self._strictEncodeArguments('getRepVotes(uint256,uint256)', [start,
        count
        ]);
            const callDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
            ...
            // tslint:disable boolean-naming
            const result = abiEncoder.strictDecodeReturnValue<Array<{wallet: string;isActive: boolean;BZRX: BigNumber;vBZRX: BigNumber;LPToken: BigNumber}>
        >(rawCallResult);
            // tslint:enable boolean-naming
            return result;
        },
    ...
    public repStakedPerToken = {
        ...
        > {
            const self = this as any as BZRXStakingInterimContract;
            const encodedData = self._strictEncodeArguments('repStakedPerToken(address,address)', [index_0,
        index_1
        ]);
            const callDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
    ...
    public rescueToken = {
        async sendTransactionAsync(
            ...
            const self = this as any as BZRXStakingInterimContract;
            const encodedData = self._strictEncodeArguments('rescueToken(address,address,uint256)', [token,
    receiver,
    amount
    ]);
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                ...
                self._web3Wrapper.getContractDefaults(),
                (self as any).rescueToken.estimateGasAsync.bind(
                    self,
                    token,
                    receiver,
                    amount
    ...
    amount
        ...
        getABIEncodedTransactionData(
            ...
            const self = this as any as BZRXStakingInterimContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('rescueToken(address,address,uint256)', [token,
    receiver,
    amount
    ]);
    ...
    public setActive = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                ...
                self._web3Wrapper.getContractDefaults(),
                (self as any).setActive.estimateGasAsync.bind(
                    self,
                    _isActive
                ),
            );
    ...
    public setRepActive = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                ...
                self._web3Wrapper.getContractDefaults(),
                (self as any).setRepActive.estimateGasAsync.bind(
                    self,
                    _isActive
                ),
            );
    ...
    public stakeWithDelegate = {
        async sendTransactionAsync(
            ...
            const self = this as any as BZRXStakingInterimContract;
            const encodedData = self._strictEncodeArguments('stakeWithDelegate(address[],uint256[],address)', [tokens,
    values,
    delegateToSet
    ]);
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                ...
                self._web3Wrapper.getContractDefaults(),
                (self as any).stakeWithDelegate.estimateGasAsync.bind(
                    self,
                    tokens,
                    values,
                    delegateToSet
    ...
    delegateToSet
        ...
        getABIEncodedTransactionData(
            ...
            const self = this as any as BZRXStakingInterimContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('stakeWithDelegate(address[],uint256[],address)', [tokens,
    values,
    delegateToSet
    ]);
            return abiEncodedTransactionData;
    ...
    public stakeableByAsset = {
        ...
        > {
            const self = this as any as BZRXStakingInterimContract;
            const encodedData = self._strictEncodeArguments('stakeableByAsset(address,address)', [token,
        account
        ]);
            const callDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
    ...
    public userRewardPerTokenPaid = {
        ...
        > {
            const self = this as any as BZRXStakingInterimContract;
            const encodedData = self._strictEncodeArguments('userRewardPerTokenPaid(address,address)', [index_0,
        index_1
        ]);
            const callDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                {
