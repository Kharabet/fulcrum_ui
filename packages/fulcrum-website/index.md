...
<section class="bg-primary bg-primary-image pt-60 pb-75">
    {% include header.html %}
    ...
    <div class="container pt-75 text-center">
        <div class="row">
            <div class="col-12">
                <h2 class="circle mb-15"><span class="blue center top-r-60"></span>How to open leveraged position?</h2>
                <p class="fs-20 lh-150 c-secondary-blue mb-75">Three clicks. No Accounts. No fees.</p>
            </div>
        </div>
        <div class="row jc-c">
            <div class="col col-10 jc-sb">
                <div class="flex fd-c">
...
<section class="bg-secondary pt-135 pb-90 text-center">
    <div class="container">
        <div class="row">
            <div class="col-12">
        ...
        <div class="row jc-sb">
            <div class="col col-4 item-safe fd-c">
                <div class="icon-safe mb-50">
    ...
    <div class="container">
        <div class="row">
            <div class="col col-12">
                <div class="item-blue flex py-40 fs-44 lh-140 jc-c">
                    <div class="col-11">
...
<section class="bg-primary pt-135 pb-60 text-center">
    <div class="container">
        <div class="row">
            <div class="col col-12 jc-c">
                <h2 class="circle mb-50"><span class="blue center top-r-60"></span>Frequently Asked Questions</h2>
            </div>
        </div>
        <div class="row jc-c">
            <div class="col col-8">
...
<section class="bg-primary pt-60 pb-105">
    <div class="container">
        <div class="row">
            <div class="col col-12 jc-c">
