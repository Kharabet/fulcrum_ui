...
export class AssetsDictionary {
  public static assets: Map<Asset, AssetDetails> = new Map<Asset, AssetDetails>([
    ...
    [Asset.DAI, new AssetDetails("0x89d24a6b4ccb1b6faa2625fe562bdd9a23260359", "DAI", dai_logo, dai_bg, "#8777B1")],
    [Asset.ETH, new AssetDetails("0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2", "ETH", eth_logo, eth_bg, "#FFFFFF")],
