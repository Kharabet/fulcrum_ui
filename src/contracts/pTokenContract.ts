...
import pTokenJson from "./../assets/artifacts/kovan/iToken.json";
...
export class pTokenContract extends BaseContract {
  ...
  public burnToToken = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as pTokenContract;
      const encodedData = self._strictEncodeArguments("burnToToken(address,address,uint256)", [
        receiver,
        burnTokenAddress,
        burnAmount
      ]);
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self._web3Wrapper.getContractDefaults(),
        (self as any).burnToToken.estimateGasAsync.bind(self, receiver, burnTokenAddress, burnAmount)
      );
      const txHash = await self._web3Wrapper.sendTransactionAsync(txDataWithDefaults);
      return txHash;
    },
    ...
    getABIEncodedTransactionData(receiver: string, burnTokenAddress: string, burnAmount: BigNumber): string {
      const self = (this as any) as pTokenContract;
      const abiEncodedTransactionData = self._strictEncodeArguments("burnToToken(address,address,uint256)", [
        receiver,
        burnTokenAddress,
        burnAmount
      ]);
    ...
    async callAsync(
      ...
      const rawCallResult = await self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock);
      BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
      const abiEncoder = self._lookupAbiEncoder("burnToToken(address,address,uint256)");
      // tslint:disable boolean-naming
      const result = abiEncoder.strictDecodeReturnValue<BigNumber>(rawCallResult);
      // tslint:enable boolean-naming
      return result;
  ...
  public initialize = {
    async sendTransactionAsync(
      ...
      _bZxVault: string,
      _bZxOracle: string,
      _wethContract: string,
      _loanTokenAddress: string,
      _tradeTokenAddress: string,
      _leverageAmount: BigNumber,
      _loanOrderHash: string,
      _name: string,
      _symbol: string,
      txData: Partial<TxData> = {}
    ): Promise<string> {
      ...
      const encodedData = self._strictEncodeArguments(
        "initialize(address,address,address,address,address,address,uint256,bytes32,string,string)",
        [
          _bZxContract,
          _bZxVault,
          _bZxOracle,
  ...
  public interestRate = {
    async callAsync(
      ...
      const self = (this as any) as pTokenContract;
      const encodedData = self._strictEncodeArguments("interestRate(uint256)", [borrowAmount]);
      const callDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        {
          to: self.address,
          ...callData,
      ...
      const rawCallResult = await self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock);
      BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
      const abiEncoder = self._lookupAbiEncoder("interestRate(uint256)");
      // tslint:disable boolean-naming
      const result = abiEncoder.strictDecodeReturnValue<BigNumber>(rawCallResult);
      // tslint:enable boolean-naming
      return result;
  ...
  public mintWithToken = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as pTokenContract;
      const encodedData = self._strictEncodeArguments("mintWithToken(address,address,uint256)", [
        receiver,
        depositTokenAddress,
        depositAmount
      ]);
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self._web3Wrapper.getContractDefaults(),
        (self as any).mintWithToken.estimateGasAsync.bind(self, receiver, depositTokenAddress, depositAmount)
      );
      const txHash = await self._web3Wrapper.sendTransactionAsync(txDataWithDefaults);
      return txHash;
    },
    ...
    getABIEncodedTransactionData(receiver: string, depositTokenAddress: string, depositAmount: BigNumber): string {
      const self = (this as any) as pTokenContract;
      const abiEncodedTransactionData = self._strictEncodeArguments("mintWithToken(address,address,uint256)", [
        receiver,
        depositTokenAddress,
        depositAmount
      ]);
    ...
    async callAsync(
      ...
      const rawCallResult = await self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock);
      BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
      const abiEncoder = self._lookupAbiEncoder("mintWithToken(address,address,uint256)");
      // tslint:disable boolean-naming
      const result = abiEncoder.strictDecodeReturnValue<BigNumber>(rawCallResult);
      // tslint:enable boolean-naming
      return result;
  ...
  constructor(address: string, provider: Provider, txDefaults?: Partial<TxData>) {
    super("pToken", pTokenJson.abi, address, provider as SupportedProvider, txDefaults);
